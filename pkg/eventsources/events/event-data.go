...
// AzureQueueStorageEventData represents the event data generated by AQS eventsource.
// +k8s:openapi-gen=true
type AzureQueueStorageEventData struct {
	// Body is the message body
	Body interface{} `json:"body"`
	// MessageID is the ID of the message
	MessageID string `json:"messageID"`
	// InsertionTime is the time the Message was inserted into the Queue.
...
// GerritEventData represents the event data generated by the Gerrit eventsource.
type GerritEventData struct {
	// Headers from the Gerrit http request.
	Headers http.Header `json:"headers"`
	// Body represents the message body
	Body *json.RawMessage `json:"body"`
	// Metadata holds the user defined metadata which will passed along the event payload.
