...
type FileEventSource struct {
	...
	// Refer https://github.com/fsnotify/fsnotify/blob/main/fsnotify.go for more information
...
type RedisStreamEventSource struct {
	// HostAddress refers to the address of the Redis host/server (main instance)
	HostAddress string `json:"hostAddress" protobuf:"bytes,1,opt,name=hostAddress"`
	// Password required for authentication if any.
	// +optional
	Password *corev1.SecretKeySelector `json:"password,omitempty" protobuf:"bytes,2,opt,name=password"`
...
type PulsarEventSource struct {
	...
	// Refer https://github.com/apache/pulsar-client-go/blob/main/pulsar/auth/athenz.go
	// Either token or athenz can be set to use auth.
	// +optional
