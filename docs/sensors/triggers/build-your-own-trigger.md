...
The complete proto file is available [here](https://github.com/nholuongut/argo-events/blob/main/pkg/sensors/triggers/trigger.proto).
          ...
          triggers:
            - template:
                ...
                custom:
                  ...
                  spec:
                    url: "https://raw.githubusercontent.com/VaibhavPage/tekton-cd-trigger/main/example.yaml"
...
1. `parameters`: The parameters override the resource that is fetched by the trigger server.
   Read more info on parameters [here](https://github.com/nholuongut/argo-events/tutorials/02-parameterization/).

1. `payload`: Payload to send to the trigger server. Read more on payload [here](https://github.com/nholuongut/argo-events/sensors/triggers/http-trigger/#request-payload).
