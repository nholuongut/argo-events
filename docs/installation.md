...
2. Deploy Argo Events SA, ClusterRoles, and Controller for Sensor, EventBus, and EventSource.
        ...
        kubectl apply -f https://raw.githubusercontent.com/nholuongut/argo-events/stable/manifests/namespace-install.yaml
...
Use either [`cluster-install`](https://github.com/nholuongut/argo-events/tree/stable/manifests/cluster-install), or [`cluster-install-with-extension`](https://github.com/nholuongut/argo-events/tree/stable/manifests/cluster-install-with-extension), or [`namespace-install`](https://github.com/nholuongut/argo-events/tree/stable/manifests/namespace-install) folder as your base for Kustomize.

`kustomization.yaml`:

    bases:
      - github.com/nholuongut/argo-events/manifests/cluster-install
      # OR
      - github.com/nholuongut/argo-events/manifests/namespace-install
...
1. Add `argoproj` repository.
        ...
        helm repo add argo https://github.com/argo-helm
...
If you are looking to migrate Argo Events <0.16.0 to v1.0.0, please read the [migration docs](https://github.com/nholuongut/argo-events/wiki/Migration-path-for-v0.17.0).
